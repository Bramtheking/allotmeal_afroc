...
export default function MarketingDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Fetch ALL services if user is admin, or only user's services if marketing
      try {
        let servicesQuery
        if (userRole === "admin") {
          ...
          // Remove the conditional query and always fetch all services
          servicesQuery = collection(db, "services")
        }
      ...
      // Fetch ALL advertisements if user is admin, or only user's advertisements if marketing
      try {
        let adsQuery
        if (userRole === "admin") {
          // Admin can see all advertisements
          adsQuery = collection(db, "advertisements")
        } else {
          // Remove the conditional query and always fetch all advertisements
