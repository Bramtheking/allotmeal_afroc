          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">To view service details</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">To view service videos</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">To post a service in this category</p>
              </div>
