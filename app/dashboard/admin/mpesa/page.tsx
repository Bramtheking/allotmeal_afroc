...
export default function MpesaAdminPage() {
  ...
  const handleSavePricing = async () => {
    ...
    if (!continueAmount && !videosAmount) {
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set payment amounts for Continue and Videos actions per service
            </CardDescription>
          </CardHeader>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-right">Continue Amount</TableHead>
                      <TableHead className="text-right">Videos Amount</TableHead>
