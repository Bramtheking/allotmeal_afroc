...
export default function AgriculturePage() {
  ...
  const handleSearch = () => {
    ...
    console.log("Searching with:", { searchTerm, locationFilter, priceFilter })
  }
            ...
            <div className="bg-white/95 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-lime-500" />
                    <Input
                      placeholder="Enter location"
                      className="pl-10 h-12 border-gray-200 focus:border-lime-400"
            ...
            <TabsContent value="all" className="space-y-6">
              {allFiltered.length === 0 ? (
                ...
                >
                  ...
                  >
                    {searchTerm || locationFilter || priceFilter ? "Clear Filters" : "Get Notified"}
                  </Button>
                </motion.div>
              ) : (
                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="text-sm">{service.location || "Location not specified"}</span>
                              </div>
                            </div>
                          </div>
        ...
        >
          ...
          <div className="relative bg-white/90 backdrop-blur-sm p-12 rounded-3xl border border-green-100 shadow-2xl text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button className="h-12 bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-600 hover:to-lime-600 px-8">
                <Phone className="mr-2 h-4 w-4" />
                Contact Agriculture Support
              </Button>
            </div>
          </div>
        </motion.div>
