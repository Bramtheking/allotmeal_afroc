                ...
                <Card key={hotel.id} className="overflow-hidden">
                  ...
                  <CardFooter className="flex justify-between">
                    <Button variant="outline" asChild>
                      <Link href={`/services/hotel-industry/${hotel.id}`}>View Details</Link>
                    </Button>
                    <Button asChild>
                      <Link href={`/services/hotel-industry/${hotel.id}`}>Book Now</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
              ...
              {hotels.map((hotel) => (
                <Card key={hotel.id} className="overflow-hidden">
                  ...
                  <CardFooter className="flex justify-between">
                    ...
                    <Button asChild>
                      <Link href={`/services/hotel-industry/${hotel.id}`}>Book Accommodation</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
