...
const buildingSites = [
  {
    ...
    description: "Luxury apartment complex with 120 units, swimming pool, and gym facilities.",
    features: ["1, 2 & 3 bedroom units", "Rooftop garden", "24/7 security", "Parking"],
  },
  {
    name: "Green Business Park",
    type: "Commercial Complex",
    location: "Mombasa Road, Nairobi",
    status: "Under Construction",
    completion: "March 2024",
    image: "/placeholder.svg?height=200&width=400",
    description: "Modern office complex with green building certification and state-of-the-art facilities.",
    features: ["Office spaces", "Conference center", "Food court", "Underground parking"],
  },
  {
    name: "Coastal Villas",
    ...
    features: ["4 & 5 bedroom villas", "Private pools", "Beach access", "Smart home features"],
  },
]

const roadProjects = [
  {
    name: "Urban Highway Expansion",
    type: "Highway Project",
    location: "Thika Road, Nairobi",
    status: "Under Construction",
    completion: "November 2023",
    image: "/placeholder.svg?height=200&width=400",
    description: "Expansion of the existing highway to accommodate increased traffic flow.",
    features: ["Lane expansion", "Pedestrian bridges", "Street lighting", "Drainage systems"],
  },
  {
    name: "Rural Access Road",
    type: "Rural Road Project",
    location: "Machakos County",
    status: "Under Construction",
    completion: "January 2024",
    image: "/placeholder.svg?height=200&width=400",
    description: "Construction of all-weather roads to improve access to rural communities.",
    features: ["Gravel roads", "Bridges", "Culverts", "Road signs"],
  },
  {
    name: "Urban Street Rehabilitation",
    type: "Urban Road Project",
    location: "Kisumu CBD",
    status: "Planning Phase",
    completion: "April 2024",
    image: "/placeholder.svg?height=200&width=400",
    description: "Rehabilitation of urban streets including drainage, sidewalks, and street lighting.",
    features: ["Road resurfacing", "Sidewalks", "Street lighting", "Drainage"],
  },
]
...
const constructionServices = [
  {
    ...
    image: "/placeholder.svg?height=200&width=400",
    description: "Professional contractors for building construction and renovation projects.",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=400",
    description: "Specialized construction services for specific technical requirements.",
    services: ["Electrical work", "Plumbing", "HVAC installation", "Roofing"],
  },
  {
    name: "Interior Finishing",
    category: "Interior Services",
    image: "/placeholder.svg?height=200&width=400",
    description: "Interior finishing services to complete your construction project.",
    services: ["Painting", "Flooring", "Cabinetry", "Interior design"],
  },
]
...
const constructionMaterials = [
  {
    ...
    image: "/placeholder.svg?height=200&width=400",
    description: "Essential building materials for construction projects.",
    items: ["Cement", "Sand", "Stones", "Bricks", "Steel"],
  },
  {
    name: "Finishing Materials",
    category: "Finishing Supplies",
    image: "/placeholder.svg?height=200&width=400",
    description: "Quality finishing materials for interior and exterior applications.",
    items: ["Tiles", "Paint", "Wallpaper", "Ceiling materials", "Flooring"],
  },
  {
    name: "Hardware & Tools",
    category: "Construction Tools",
    image: "/placeholder.svg?height=200&width=400",
    description: "Hardware and tools for construction and DIY projects.",
    items: ["Hand tools", "Power tools", "Fasteners", "Adhesives", "Safety equipment"],
  },
]
