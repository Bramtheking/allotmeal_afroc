                    ...
                    >
                      ...
                      <CardFooter className="flex gap-2">
                        <Button variant="outline" className="flex-1" asChild>
                          <Link href={`/services/construction/${site.id}`}>View Details</Link>
                        </Button>
                        <Button className="flex-1" asChild>
                          <Link href={`/services/construction/${site.id}`}>Contact Developer</Link>
                        </Button>
                      </CardFooter>
                    </Card>
                  ))}
                  ...
                  {roadProjects.map((project) => (
                    ...
                    >
                      ...
                      <CardFooter className="flex gap-2">
                        ...
                        <Button className="flex-1" asChild>
                          <Link href={`/services/construction/${project.id}`}>Contact Contractor</Link>
                        </Button>
                      </CardFooter>
                    </Card>
                  ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {constructionMaterials.map((material) => (
                ...
                >
                  ...
                  <CardFooter className="flex gap-2">
                    <Button variant="outline" className="flex-1" asChild>
                      <Link href={`/services/construction/${material.id}`}>View Details</Link>
                    </Button>
                    <Button className="flex-1" asChild>
                      <Link href={`/services/construction/${material.id}`}>Order Now</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {constructionServices.map((service) => (
                ...
                >
                  ...
                  <CardFooter className="flex gap-2">
                    <Button variant="outline" className="flex-1" asChild>
                      <Link href={`/services/construction/${service.id}`}>View Portfolio</Link>
                    </Button>
                    <Button className="flex-1" asChild>
                      <Link href={`/services/construction/${service.id}`}>Hire Service</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
