                        ...
                        <CardContent className="space-y-4 flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                              ...
                              <p className="font-semibold text-green-600">{tender.value || tender.price || "$500K"}</p>
                            </div>
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                        ...
                        <CardContent className="space-y-4 flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                              ...
                              <p className="font-semibold text-green-600">{tender.value || tender.price || "$1.2M"}</p>
                            </div>
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                                <Clock className="h-4 w-4 text-orange-500" />
        ...
        >
          ...
          <div className="relative bg-white/90 backdrop-blur-sm p-12 rounded-3xl border border-slate-100 shadow-2xl text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button className="h-12 bg-gradient-to-r from-slate-500 to-gray-600 hover:from-slate-600 hover:to-gray-700 px-8">
