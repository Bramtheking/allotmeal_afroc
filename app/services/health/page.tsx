        ...
        >
          ...
          <div className="relative bg-white/90 backdrop-blur-sm p-12 rounded-3xl border border-red-100 shadow-2xl text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Get immediate medical support, book appointments, or connect with healthcare professionals.
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button className="h-12 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 px-8">
