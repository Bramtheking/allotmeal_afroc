                ...
                >
                  ...
                  <CardFooter className="flex gap-2">
                    <Button variant="outline" className="flex-1" asChild>
                      <Link href={`/services/transport/${item.id}`}>View Schedule</Link>
                    </Button>
                    <Button className="flex-1" asChild>
                      <Link href={`/services/transport/${item.id}`}>Book Now</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {airTransport.map((item) => (
                ...
                >
                  ...
                  <CardFooter className="flex gap-2">
                    <Button variant="outline" className="flex-1" asChild>
                      <Link href={`/services/transport/${item.id}`}>View Flights</Link>
                    </Button>
                    <Button className="flex-1" asChild>
                      <Link href={`/services/transport/${item.id}`}>Book Now</Link>
                    </Button>
